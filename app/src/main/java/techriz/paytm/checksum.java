...
//
    ...
    public class sendUserDetailTOServerdd extends AsyncTask<ArrayList<String>, Void, String> {
        ...
        String url ="https://paymenthardik.000webhostapp.com/Paytm/generateChecksum.php";//TODO your server's url here (www.xyz/checksumGenerate.php)
        ...
        protected String doInBackground(ArrayList<String>... alldata) {
            ...
            Log.d("CheckSum",jsonObject.toString());
    ...
    public void onTransactionResponse(Bundle bundle) {
        ...
        Log.d("checksum" , bundle.toString());
    }
